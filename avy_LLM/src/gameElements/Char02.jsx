...
Command: npx gltfjsx@6.2.16 Char02Idle.glb 
*/
...
export default function Char02(props) {
  const ref = useRef()
  const { nodes, materials} = useGLTF('./models/Char02/Char02Idle.glb')
  const idleAnimation = useGLTF('./models/Char02/Char02Idle.glb').animations
  const walkAnimation = useGLTF('./models/Char02/Char02Walk.glb').animations
  const jumpAnimation = useGLTF('./models/Char02/Char02Jump.glb').animations
  const danceAnimation = useGLTF('./models/Char02/Char02Dance.glb').animations
  const helloAnimation = useGLTF('./models/Char02/Char02Hello.glb').animations
...
// useGLTF.preload([
//   "./models/Char02/Char02Idle.glb", 
//   "./models/Char02/Char02Walk.glb", 
//   "./models/Char02/Char02Jump.glb", 
//   "./models/Char02/Char02Dance.glb",
