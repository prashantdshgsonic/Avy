...
Command: npx gltfjsx@6.2.16 Char05Idle.glb 
*/
...
export default function Char05(props) {
  const ref = useRef()
  const { nodes, materials} = useGLTF('./models/Char05/Char05Idle.glb')
  const idleAnimation = useGLTF('./models/Char05/Char05Idle.glb').animations
  const walkAnimation = useGLTF('./models/Char05/Char05Walk.glb').animations
  const jumpAnimation = useGLTF('./models/Char05/Char05Jump.glb').animations
  const danceAnimation = useGLTF('./models/Char05/Char05Dance.glb').animations
  const helloAnimation = useGLTF('./models/Char05/Char05Hello.glb').animations
...
// useGLTF.preload([
//   "./models/Char05/Char05Idle.glb", 
//   "./models/Char05/Char05Walk.glb", 
//   "./models/Char05/Char05Jump.glb", 
//   "./models/Char05/Char05Dance.glb",
